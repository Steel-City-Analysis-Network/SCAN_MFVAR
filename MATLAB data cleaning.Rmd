...
df.q2 <- df.q %>% 
  select("DATE1", "pghngdp", "fpi", "old.q.number", "patax", "pghaww", "pghawwp", "pghhouse", "pghmanuf", "pghqwage")
...
ls(df.m)
df.m2 <- df.m %>% 
  select("DATE1","baa", "fedfunds", "gs10", "monthnumber", "paclaims", "pcepi", "pcepilfe", "pghcivlabforce", "pghempmanuf", "pghpermits", "pghunemp")
...
## Output data sets 
```{r} 
write.csv(df.m2.logs, "C:\\Users\\brobs\\Documents\\MATLAB.monthly.alpah.data.csv")
write.csv(df.q2.logs, "C:\\Users\\brobs\\Documents\\MATLAB.monthly.alpha.data.csv")
```
